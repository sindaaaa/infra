...
resource "aws_instance" "instance_1" {
  ami             = "ami-0778521d914d23bc1" # Ubuntu 20.04 LTS // us-east-1
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "python3 S3_push.py",
      "sleep 330",
      "sudo ./infra/monitoring.sh",
      "sleep 120",
      "chmod +x spark.sh",
      "sudo ./spark.sh",
      "sleep 180",
      "sudo kubectl port-forward  --address=0.0.0.0 --namespace default svc/projet-spark-master-svc 80:80 > /dev/null &"
...
output "Spark_Dashboard_Address" {
